  ...
  return (
    <>
      <div className="btn-group" id="cantidad">
        <button type="button" className="btn px-2" onClick={() => setCantidad( cantidad<=0 ? cantidad : cantidad - 1)}>
        ...
        <button type="button" className="btn px-2" onClick={() => setCantidad( cantidad<articulo.stock ? cantidad + 1 : cantidad )}>
